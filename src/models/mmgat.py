...
class MMGAT(GeneralRecommender):
    ...
    def forward(self):
        ...
        all_embs = torch.stack(all_embs, dim=0)  # [n_layers+1, n_nodes, embedding_dim]
        x = (all_embs * weights.view(-1, 1, 1)).sum(dim=0)  # [n_nodes, embedding_dim]
